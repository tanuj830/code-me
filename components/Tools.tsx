        ...
        <div className="container px-5 py-10 mx-auto">
          <div className="flex items-center lg:px-20 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
            ...
            <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0">
              ...
              <p className="leading-relaxed text-base">
                Pollish your coding skills with CODE CHAT while chatting.
              </p>
              <Link
                href="/"
          ...
          <div className="flex items-center lg:px-20  mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
            <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0">
              ...
              <p className="leading-relaxed text-base">
                In today&apos;s world for landing job one should have strong and
                ats friendly resume, Geeky Works helps to build resume.
              </p>
              <Link
                href="/"
                className="mt-3 text-indigo-500 inline-flex items-center"
          ...
          <div className="flex items-center lg:px-20 mx-auto sm:flex-row flex-col">
            <div className="sm:w-32 sm:h-32 h-20 w-20 sm:mr-10 inline-flex items-center justify-center rounded-full bg-indigo-100 text-indigo-500 flex-shrink-0">
              <svg
                fill="none"
                stroke="currentColor"
